    ...
    public static void main(String[] args) {
        /*
         ...
         The basic hamburger should have the following items.
             bread roll type
             meat
             up to 4 additional additions (things like lettuce, tomato, carrot, etc) that the customer can select to be added to the burger.

         Each item gets charged an additional price, so track how many items got added and calculate the final price (base burger with all the additions).
         ...
         All 3 classes should have a method that can be called anytime to show the base price of the hamburger plus all additions:
             showing the addition name, and addition price, and a grand/final total for the burger (base price + all additions)

         For the two additional classes this may require you to be looking at the base class for pricing and then
         adding totals to final price.
         */

        Hamburger hamburger = new Hamburger("Basic", "Beef", "White", 5.00 );
        double price = hamburger.itemizeHamburger();
        hamburger.addHamburgerAddonOne("Tomato", 0.27);
        hamburger.addHamburgerAddonTwo("Cheese", 1.50);
        hamburger.addHamburgerAddonThree("Lettuce", 0.46);
        System.out.println("Total is $" + hamburger.itemizeHamburger());

        HealthyBurger healthyBurger = new HealthyBurger("Bacon", 5.67);
        healthyBurger.addHealthyAddonOne("Egg", 5.43);
        healthyBurger.addHealthyAddonTwo("Lentils", 3.41);
        System.out.println("Total for healthy: $" + healthyBurger.itemizeHamburger());

        Deluxe deluxe = new Deluxe();
        deluxe.addHamburgerAddonOne("Pickles", .15);
